      ...
      </div>
      {
        checkBasket ? (
          ...
          <>
            ...
            <p className={styles.basket__order}>Minimum order amount <span>400</span> $</p>
            <div className={styles.basket__footer}>
              ...
              <button className={styles.basket__order_btn} onClick={()=>alert('Good choice!')}>Checkout</button>
            </div>
          </>
        )
      }
